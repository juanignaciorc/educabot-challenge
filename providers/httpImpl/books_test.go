...
func TestHTTPBooksProvider_GetBooks_Error(t *testing.T) {
...
func TestHTTPBooksProvider_GetBooks_ContextCanceled(t *testing.T) {
	...
	books := provider.(*HTTPBooksProvider).GetBooks(ctx)
...
func TestHTTPBooksProvider_GetBooks_InvalidData(t *testing.T) {
	...
	// Verify books are returned even with missing fields, since the provider

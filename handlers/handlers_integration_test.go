...
import (
	...
	"educabot.com/bookshop/providers/httpImpl"
...
// Para ejecutar esta prueba: go test -tags=integration ./handlers
func TestHandlerIntegration(t *testing.T) {
	...
	// Crear el proveedor real de libros
	booksProvider := httpImpl.NewHTTPBooksProviderWithConfig(
		client,
		"https://6781684b85151f714b0aa5db.mockapi.io/api/v1/books",
	)

	// Crear el servicio con el proveedor real
...
func TestHandlerTimeout(t *testing.T) {
	...
	// Crear el proveedor real de libros con un timeout que causará fallo
	booksProvider := httpImpl.NewHTTPBooksProviderWithConfig(
		client,
		"https://6781684b85151f714b0aa5db.mockapi.io/api/v1/books",
	)

	// Crear el servicio con el proveedor
	metricsService := services.NewMetricsService(booksProvider)
